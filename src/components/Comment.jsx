...
export const Comment = ({
  ...
  const voteHandler = async (parentComment, voteType) => {
    ...
    await fetch("https://mindeasefinalbak-production.up.railway.app/commentVote", {
      method: "PUT",
      headers: {
  ...
  const submitHandler = async (e) => {
    ...
    const res = await axios.post("https://mindeasefinalbak-production.up.railway.app/createComment", {
      body: comment,
      post: postId,
      ...
      <div className='border-2 border-l-1 flex p-1 mb-2 border-green-600'>
        ...
        <div>
          ...
          >
            ...
            <button className='text-gray-600'>Responder</button>
          </div>
        </div>
      </div>
      {isReply && (
